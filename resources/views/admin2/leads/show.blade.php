...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin2.leads.index') }}" class="btn btn-outline-secondary">Kembali</a>
</div>
    ...
    <div class="col-lg-8">
        <div class="card mb-4" style="border-radius:16px;border:1px solid #e6edf7;box-shadow:0 10px 24px rgba(21,33,54,0.08);">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin2.leads.activities.store', $lead->lead_id) }}" class="row g-2">
                    @csrf
                    <div class="col-md-3">
