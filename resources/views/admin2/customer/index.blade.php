...
.a6{animation:fadeUp .42s ease .34s both}
...
.cust-stat:hover {
    ...
    box-shadow: 0 14px 36px rgba(11,23,54,.12);
}
.cust-stat::after {
    content:'';
    position:absolute;
...
.cust-table-panel {
    ...
    border: 1px solid #E8EFF8;
    overflow: hidden;
    box-shadow: 0 6px 30px rgba(11,23,54,.07);
}
.cust-table-head {
...
table.cust-table thead th:first-child { padding-left: 24px; }
table.cust-table thead th:last-child { padding-right: 24px; text-align:right; }
...
table.cust-table tbody td:first-child { padding-left: 24px; }
table.cust-table tbody td:last-child  { padding-right: 24px; text-align:right; }
table.cust-table tbody tr:last-child td { border-bottom: none; }
...
tr:hover .cust-avatar {
    transform: scale(1.06);
    box-shadow: 0 8px 20px rgba(11,23,54,.3);
}
.cust-name {
    font-weight: 700;
    color: #1D2A44;
...
.cust-booking-badge {
    ...
    font-weight: 700;
    font-size: .76rem;
    box-shadow: 0 4px 12px rgba(11,23,54,.2);
    transition: transform .2s, box-shadow .2s;
}
.cust-booking-badge:hover {
    transform: translateY(-1px);
    box-shadow: 0 6px 16px rgba(11,23,54,.28);
}
...
.cust-pagination .page-link:hover {
    background: #EEF3FF;
    border-color: #BFDBFE;
    color: #1D4ED8;
}
...
<div class="cust-hero a1">
    <div class="d-flex align-items-center gap-4" style="position:relative;z-index:1">
        <div class="cust-hero-icon">
            <i class="bi bi-people-fill"></i>
        </div>
        <div class="flex-1">
            <div class="cust-hero-eyebrow">Admin Panel · Manajemen</div>
            <h4 class="cust-hero-title">Data Customer</h4>
            <p class="cust-hero-sub">Daftar semua client yang pernah booking di Enamorapic</p>
        </div>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-lg-3 a2" style="animation-delay:.06s">
        <div class="cust-stat" style="--sc:#8B5CF6">
            <div class="cust-stat-deco"></div>
            <div class="cust-stat-icon" style="background:#F5F3FF;color:#8B5CF6">
    ...
    <div class="col-6 col-lg-3 a2" style="animation-delay:.18s">
        <div class="cust-stat" style="--sc:#10B981">
            <div class="cust-stat-deco"></div>
            <div class="cust-stat-icon" style="background:#ECFDF5;color:#10B981">
...
<div class="cust-search-wrap a3">
    <form method="GET" class="row g-2 align-items-end">
        <div class="col">
            <label style="font-size:.68rem;text-transform:uppercase;letter-spacing:.08em;color:#64748B;font-weight:700;margin-bottom:6px;display:block">
                Cari Customer
            </label>
...
<div class="cust-table-panel a4">
    <div class="cust-table-head">
        <div class="cust-table-head-title">
            <span style="width:28px;height:28px;border-radius:8px;background:#EEF3FF;color:#2563EB;display:inline-flex;align-items:center;justify-content:center;font-size:.82rem;">
                <i class="bi bi-table"></i>
            </span>
            Daftar Customer
        </div>
        <span class="cust-table-count">{{ $customers->total() }} data</span>
    </div>
    ...
    <div class="table-responsive">
        <table class="cust-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <span class="cust-row-no">{{ $no + 1 }}</span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        @else
                            <span class="cust-paket-dash">—</span>
                        @endif
                    </td>
                    <td>
                        @if($totalTerms > 0)
...
<div class="d-flex justify-content-center mt-4 cust-pagination a5">
