                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <a href="{{ route('admin.customer.show', $c->customer_id) }}"
                               class="btn btn-outline-primary btn-sm customer-action-btn me-1" title="Lihat Detail">
                                <i class="bi bi-eye"></i>
                            </a>
                                <form action="{{ route('admin.customer.destroy', $c->customer_id) }}" method="POST" style="display:inline;"
                                    data-confirm="Hapus customer {{ addslashes($c->nama_client) }}? Semua booking terkait juga akan terhapus!"
                                    data-confirm-type="delete"
                                    data-confirm-title="Hapus Customer">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn btn-outline-danger btn-sm customer-action-btn" title="Hapus">
