...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Informasi lengkap partner WO</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.wo.edit', $wo->wo_id) }}" class="btn btn-outline-warning">Edit</a>
        <a href="{{ route('admin.wo.index') }}" class="btn btn-outline-secondary">Kembali</a>
    </div>
</div>
